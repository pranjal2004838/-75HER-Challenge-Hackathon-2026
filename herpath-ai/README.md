...
📹 [**Watch Demo Video**](scripts/demo_video.mp4) (10 MB, MP4)
...
| Onboarding Wizard | ![Onboarding](scripts/screenshots/05_step1_goal.png) |
| Profile Summary | ![Profile](scripts/screenshots/11_step7_profile_summary.png) |
| AI-Generated Roadmap | ![Roadmap](scripts/screenshots/17_roadmap_overview.png) |
| Dashboard | ![Dashboard](scripts/screenshots/13_dashboard_top.png) |
| AI Coach | ![Coach](scripts/screenshots/30_coach_response1.png) |
| Progress Tracking | ![Progress](scripts/screenshots/21_progress_metrics.png) |
| Rebalancing | ![Rebalance](scripts/screenshots/35_roadmap_after_rebalance.png) |
...
- [Goose Framework](docs/GOOSE.md) — Custom agentic AI implementation
- [API Reference](docs/API.md) — Endpoints and data models
- [Deployment Guide](docs/DEPLOYMENT.md) — Production deployment
- [AI Trace Log](docs/AI_TRACE_LOG.md) — AI decision-making log (required for AI/ML track)
